...
pushButton_t pushButtons[NUM_PUSHBUTTONS] =
{
    ...
    */
    ...
    { 168, 62, 18, 13, true,  3, ARROW_UP_STRING,   NULL,    pbIncAdd,       NULL },
    { 185, 62, 18, 13, true,  3, ARROW_DOWN_STRING, NULL,    pbDecAdd,       NULL },
    ...
    { 359,   2, 59, 16, false, 0, "Play sng.",  NULL,    NULL,       pbPlaySong },
    { 359,  19, 59, 16, false, 0, "Play ptn.",  NULL,    NULL,       pbPlayPtn },
    { 359,  36, 59, 16, false, 0, "Stop",       NULL,    NULL,       stopPlaying },
    { 359,  53, 59, 16, false, 0, "Rec. sng.",  NULL,    NULL,       pbRecSng },
    { 359,  70, 59, 16, false, 0, "Rec. ptn.",  NULL,    NULL,       pbRecPtn },
