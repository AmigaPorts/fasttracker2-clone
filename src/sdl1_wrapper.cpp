                                                ...
                                                Uint32 format)
{
    ...
    return SDL_CreateRGBSurfaceFrom(pixels, width, height, depth, pitch, bmask, gmask, rmask, 0);
}
...
SDL_AudioDeviceID SDL_OpenAudioDevice(const char* device, int iscapture,
                                      ...
                                      int                  allowed_changes)
{
  int dev = SDL_OpenAudio(const_cast<SDL_AudioSpec*>(desired), const_cast<SDL_AudioSpec*>(obtained));
  return (SDL_AudioDeviceID)dev+1;
