...
radioButton_t radioButtons[NUM_RADIOBUTTONS] =
{
    ...
    */
    ...
    //x,   y,   w,  group,                      funcOnUp
    { 509, 16,  66, RB_GROUP_CONFIG_AUDIO_FREQ, rbConfigAudio32kHz },
#ifdef __APPLE__
    { 509, 30, 121, RB_GROUP_CONFIG_AUDIO_FREQ, rbConfigAudio44kHz },
    { 509, 44,  66, RB_GROUP_CONFIG_AUDIO_FREQ, rbConfigAudio48kHz },
#else
    { 509, 30,  66, RB_GROUP_CONFIG_AUDIO_FREQ, rbConfigAudio44kHz },
    { 509, 44, 121, RB_GROUP_CONFIG_AUDIO_FREQ, rbConfigAudio48kHz },
#endif
    { 509, 58,  66, RB_GROUP_CONFIG_AUDIO_FREQ, rbConfigAudio96kHz },
